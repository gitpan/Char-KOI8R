...
# eval <<'END' has eval "..."
if (eval Char::KOI8R::escape <<'END') {
eval Char::KOI8R::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } "
END
...
if (eval Char::KOI8R::escape <<'END') {
eval Char::KOI8R::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
...
# eval <<'END' has eval '...'
if (eval Char::KOI8R::escape <<'END') {
eval Char::KOI8R::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } '
END
...
# eval <<'END' has eval q{...}
if (eval Char::KOI8R::escape <<'END') {
eval Char::KOI8R::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
