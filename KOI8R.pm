...
=item * Only KOI8R.pm and Ekoi8r.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Ekoi8r::lc
  lcfirst     Ekoi8r::lcfirst
  uc          Ekoi8r::uc
  ucfirst     Ekoi8r::ucfirst
  chr         Ekoi8r::chr
  glob        Ekoi8r::glob
  ---------------------------------
...
KOI8R.pm remove 'bytes::' at head of function name.
...
KOI8R.pm remove '\' at head of alphanumeric regexp metasymbols \N, \p, \P
