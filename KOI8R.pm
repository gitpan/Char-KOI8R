...
=head1 Un-Escaping \ of \N, \p, \P, and \X (KOI8R software provides)

KOI8R software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (KOI8R software provide)
