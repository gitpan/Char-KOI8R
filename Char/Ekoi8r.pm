...
This module is a run-time routines of the Char/KOI8R.pm.
Because the Char/KOI8R.pm automatically uses this module, you need not use directly.
...
=item Chop string
  ...
  character chopped. The Char::Ekoi8r::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Ekoi8r::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Char::Ekoi8r::fc function for case-insensitive comparisons via Char::KOI8R
  software.
...
=item Fold case string
  ...
  New to Char::KOI8R software, this function returns the full Unicode-like casefold of
...
=item Filename expansion (globbing)
  ...
  The Char::Ekoi8r::glob function grandfathers the use of whitespace to separate multiple
