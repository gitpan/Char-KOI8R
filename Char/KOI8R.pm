...
=item * Possible to handle raw KOI8-R values

=item * Backward compatibility of data, script and how to

=item * Only Char/KOI8R.pm and Char/Ekoi8r.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Char::Ekoi8r::lc
  lcfirst     Char::Ekoi8r::lcfirst
  uc          Char::Ekoi8r::uc
  ucfirst     Char::Ekoi8r::ucfirst
  chr         Char::Ekoi8r::chr
  glob        Char::Ekoi8r::glob
  ---------------------------------
...
Char/KOI8R.pm remove 'bytes::' at head of function name.
...
Char/KOI8R.pm remove '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
page 402 of Programming Perl, 3rd ed. again.
  ...
  Information processing model beginning with this software
    ...
    +-----------------------------------+
    |      ASCII Compatible Encoding    | ex. KOI8-R
    +-----------------------------------+
                (No UTF8 Flag)
