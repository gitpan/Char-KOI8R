...
######################################################################
#
# Char::KOI8R - Source code filter to KOI8-R script
#
...
sub Char::KOI8R::escape_script {
    ...
    if (/^ use Char::Ekoi8r(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Ekoi8r %s;\n%s", $Char::Ekoi8r::VERSION, $use_re_eval); # require run-time routines version
...
Char::KOI8R - Source code filter to escape KOI8-R

=head1 SYNOPSIS

  use Char::KOI8R;
  use Char::KOI8R version;         --- require version
