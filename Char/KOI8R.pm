...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Ekoi8r::function_ord     = 'Char::KOI8R::ord'     if /\A ord \z/oxms;
                    $Char::Ekoi8r::function_ord_    = 'Char::KOI8R::ord_'    if /\A ord \z/oxms;
                    $Char::Ekoi8r::function_reverse = 'Char::KOI8R::reverse' if /\A reverse \z/oxms;
                    $Char::Ekoi8r::function_getc    = 'Char::KOI8R::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::KOI8R::escape();
...
=head1 Calling 'Char::Ekoi8r::ignorecase()' (Char::KOI8R software provides)

Char::KOI8R software applies calling 'Char::Ekoi8r::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::KOI8R software provides)

Char::KOI8R software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::KOI8R software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::KOI8R software provides)

Char::KOI8R software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::KOI8R software and
